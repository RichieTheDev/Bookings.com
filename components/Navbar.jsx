...
const Navbar = () => {
  ...
  return (
    <>
      <div className="flex sticky z-20 top-0 items-center font-medium bg-[#00008b] md:px-10 sm:px-4 lg:px-36  h-full w-full p-4">
        <h1 className=" text-2xl pt-2 mr-auto">Bookings.com</h1>
        ...
        <div className="block ml-auto sm:hidden" onClick={handleClick}>
      ...
      <div className="hidden sm:flex items-center font-medium text-sm bg-[#00008b] md:px-10 sm:px-4 lg:px-36 space-x-4 p-2">
